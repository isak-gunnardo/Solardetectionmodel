...
def detect_solar_panels_v2(image_path, min_area=200, max_area=50000):
    ...
    # panels = solar_panels  # Alias för att undvika scope-problem
    # img_width, img_height = width, height
    # Spara och returnera först efter att result är skapad
    # ...existing code...
    # Spara bild efter att result har skapats och bearbetats
    # (Flytta cv2.imwrite till rätt plats om det behövs)
